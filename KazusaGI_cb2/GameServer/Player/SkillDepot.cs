...
namespace KazusaGI_cb2.GameServer
{
	public class SkillDepot
	{
		...
		{
			// hk4e stores a dedicated core_proud_skill_ptr_ on SkillDepot; its
			// level is independent from the number of constellation talents.
			return Owner.GetCoreProudSkillLevel();
		}
